...
const PulseApp = () => {
  ...
  return (
    <div className={cn("bg-slate-50", activeRole === 'rohan' ? "h-screen overflow-hidden flex flex-col" : "min-h-screen")}>
      ...
      {/* ─── MAIN CONTENT ─── */}
      <main className={cn(activeRole === 'rohan' ? "flex-1 min-h-0 overflow-hidden" : "pb-40")}>
        <AnimatePresence mode="wait">
          {isSearchActive ? (
            ...
            <motion.div
              ...
              className={activeRole === 'rohan' ? 'h-full' : undefined}
            >
